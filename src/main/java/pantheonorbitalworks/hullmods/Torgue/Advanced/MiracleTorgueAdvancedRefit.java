...
public class MiracleTorgueAdvancedRefit extends BaseHullMod {

	public float QualityMultiplier = 2f;
	public String Quality = "Miracle";
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		stats.getMissileWeaponRangeBonus().modifyPercent(id, -AdvancedConstants.MissileRangeBalanse);
	}
